...
from datasets.smartphone_traffic_common import TRAFFIC_LABELS

# Original dataset organisation.
DIRECTORY_ANNOTATIONS = 'auto_label/201702071403/'
# DIRECTORY_ANNOTATIONS = 'traffic_test_label/201702071403/'
DIRECTORY_IMAGES = 'traffic_img/201702071403/'
...
def _process_image(directory, name):
    ...
    for obj in root.findall('object'):
        ...
        labels.append(int(TRAFFIC_LABELS[label][0]))
